...
@compressed_assembly_descriptors = dso_local local_unnamed_addr global [126 x %struct.CompressedAssemblyDescriptor] [
	...
	%struct.CompressedAssemblyDescriptor {
		i32 1996800, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i1 false, ; bool loaded
		i32 12107872; uint32_t buffer_offset
	}, ; 123: Java.Interop
	%struct.CompressedAssemblyDescriptor {
		i32 22048, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 12278880; uint32_t buffer_offset
	}, ; 124: Mono.Android.Runtime
	%struct.CompressedAssemblyDescriptor {
		i32 2032640, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 12300928; uint32_t buffer_offset
	} ; 125: Mono.Android
], align 16

@uncompressed_assemblies_data_size = dso_local local_unnamed_addr constant i32 14333568, align 4

@uncompressed_assemblies_data_buffer = dso_local local_unnamed_addr global [14333568 x i8] zeroinitializer, align 16
